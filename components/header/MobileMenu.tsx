  ...
  return (
    <Sheet>
      ...
      <SheetContent>
        ...
        <div className='p-5'>
          <div className='p-2 bg-primary flex items-center justify-center w-fit rounded-md'>
            TW
          </div>
              ...
              <SheetClose key={label} asChild className=''>
                <Link
                  ...
                  className={buttonVariants({
                    ...
                    // size: 'lg',
                    className:
                      'w-full font-semibold py-6 text-lg! justify-start hover:bg-primary! transition-all duration-300',
                  })}
                >
                  <span>{label}</span>
          ...
          <div className='flex gap-3 items-center justify-center mt-12'>
            ...
            {SOCIALS.map((social) => (
              <div
                key={social.label}
                className='p-2 rounded-full bg-muted w-fit border-2 border-border hover:border-primary transition-colors duration-300'
              >
                <Link
                  href={social.href}
                  target='_blank'
